...
Don't get caught in the weeds of a problem. Often take a step back and think is there a bigger picture reason for an issue or set of issues so we don't go down rabbit holes of small fixes. 
